...
- turboConsoleLog.includeFileName (boolean): Whether to include the file name in the log message.

- turboConsoleLog.includeLineNum (boolean): Whether to include the line number of the log message.
