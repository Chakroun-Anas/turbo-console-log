declare module "vscode" {
   ...
   */
  declare export interface DecorationRenderOptions
   ...
   */
  declare export type DocumentSelector =
    | string
    | DocumentFilter
   ...
   */
  declare export type MarkedString =
    | string
    | {
        language: string,
        value: string,
  ...
  declare export var window: {
     ...
     * when the message was dismissed.
     */
    showInformationMessage<T: MessageItem>(
      message: string,
      ...items: T[]
    ): Thenable<T>,
    /**
     ...
     * when the message was dismissed.
     */
    showWarningMessage<T: MessageItem>(
      message: string,
      ...items: T[]
    ): Thenable<T>,
    /**
     ...
     * when the message was dismissed.
     */
    showErrorMessage<T: MessageItem>(
      message: string,
      ...items: T[]
    ): Thenable<T>,
    /**
