import { functionParameterChecker } from '@/debug-message/python/PythonDebugMessage/msg/logMessage/helpers/functionParameterChecker';
import { makeTextDocument } from '@/jest-tests/mocks/helpers/';
import { parseCode } from '@/debug-message/python/PythonDebugMessage/msg/python-parser-utils/parseCode';
import passingCases from './passingCases';
import failingCases from './failingCases';

describe('Python functionParameterChecker', () => {
