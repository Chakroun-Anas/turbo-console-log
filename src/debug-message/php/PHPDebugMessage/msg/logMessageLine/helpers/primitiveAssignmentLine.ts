/**
 * Helper function to calculate the line where a log message should be inserted
 * for PHP primitive variable assignments.
 *
 ...
 * @returns The line number where the log should be inserted (0-based)
 */
