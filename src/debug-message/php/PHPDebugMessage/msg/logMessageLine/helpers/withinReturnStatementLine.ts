/**
 * Helper function to calculate the log insertion line for variables within return statements.
 * The log should be inserted BEFORE the return statement.
 */
        ...
        if (node.loc) {
          ...
          if (selectionLine >= start && selectionLine <= end) {
            ...
            if (
              ...
              // Insert log BEFORE the return statement (at the start line of return)
              line = start;
            }
          }
        }
