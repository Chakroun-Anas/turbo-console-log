/**
 * Extracts script content from HTML files and returns the content with offsets.
 ...
 *
 * @param sourceCode - The full HTML source code
 ...
 */
export function extractHtmlScript(
  sourceCode: string,
  ...
  if (selectionLine !== undefined) {
    ...
    if (matchContainingLine) {
      ...
      throw new Error(
        'Turbo logging works only inside <script> blocks in HTML files.',
      );
    }
  }
