...
/**
 * Notification handler for Activation Day Three
 * Targets new users with zero usage between 3-7 days after install
 */
export const activationDayThreeHandler: NotificationEventHandler = {
  id: 'activationDayThree',
